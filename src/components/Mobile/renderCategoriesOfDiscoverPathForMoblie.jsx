...
function RenderCategoriesInDiscoverPathForMobile() {
                    ...
                    return(
                        <div key={i * -1}>
                            ...
                            <ul className="flex flex-row overflow-x-scroll overflow-y-hidden 
                                gap-[2rem] pt-[1.5rem] pb-[2rem] ul-list">

                                <SongCardForMobile list= {item.list}/>                               
                            </ul>
                        </div>
                    )
                })
...
export default RenderCategoriesInDiscoverPathForMobile;